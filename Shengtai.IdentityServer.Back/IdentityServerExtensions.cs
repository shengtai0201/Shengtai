...
namespace Shengtai.IdentityServer
{
    public static class IdentityServerExtensions
    {
        public static void AddIdentityServer<TUser>(this IServiceCollection services, string connectionString, string assemblyName) where TUser : Models.Account.ApplicationUser
        {
            ...
            services.AddScoped<Models.IdentityServerService<TUser>>();
            services.AddScoped<ISignInService>(x => x.GetRequiredService<Models.IdentityServerService<TUser>>());
            services.AddScoped<IUserService>(x => x.GetRequiredService<Models.IdentityServerService<TUser>>());
            services.AddScoped<IEmailService>(x => x.GetRequiredService<Models.IdentityServerService<TUser>>());
            #endregion
